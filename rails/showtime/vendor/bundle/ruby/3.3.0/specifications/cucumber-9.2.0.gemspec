...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<cucumber-ci-environment>.freeze, ["> 9".freeze, "< 11".freeze])
  s.add_runtime_dependency(%q<cucumber-core>.freeze, ["> 13".freeze, "< 14".freeze])
  s.add_runtime_dependency(%q<cucumber-cucumber-expressions>.freeze, ["~> 17.0".freeze])
  s.add_runtime_dependency(%q<cucumber-gherkin>.freeze, ["> 24".freeze, "< 28".freeze])
  s.add_runtime_dependency(%q<cucumber-html-formatter>.freeze, ["> 20.3".freeze, "< 22".freeze])
  ...
  s.add_development_dependency(%q<cucumber-compatibility-kit>.freeze, ["~> 15.0".freeze])
  s.add_development_dependency(%q<nokogiri>.freeze, ["~> 1.14".freeze])
  s.add_development_dependency(%q<rake>.freeze, ["~> 13.1".freeze])
  s.add_development_dependency(%q<rspec>.freeze, ["~> 3.12".freeze])
  s.add_development_dependency(%q<rubocop>.freeze, ["~> 1.56.4".freeze])
  s.add_development_dependency(%q<rubocop-capybara>.freeze, ["~> 2.19.0".freeze])
  ...
  s.add_development_dependency(%q<rubocop-rspec>.freeze, ["~> 2.25.0".freeze])
