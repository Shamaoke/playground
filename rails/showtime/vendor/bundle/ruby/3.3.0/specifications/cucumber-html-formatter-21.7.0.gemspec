# -*- encoding: utf-8 -*-
# stub: cucumber-html-formatter 21.7.0 ruby lib

Gem::Specification.new do |s|
  s.name = "cucumber-html-formatter".freeze
  s.version = "21.7.0".freeze
  ...
  s.summary = "cucumber-html-formatter-21.7.0".freeze

  s.installed_by_version = "3.5.16".freeze if s.respond_to? :installed_by_version

  s.specification_version = 4

  s.add_runtime_dependency(%q<cucumber-messages>.freeze, ["> 19".freeze, "< 27".freeze])
  s.add_development_dependency(%q<cucumber-compatibility-kit>.freeze, ["~> 15.2".freeze])
