# -*- encoding: utf-8 -*-
# stub: cucumber-rails 3.0.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/cucumber/cucumber-rails/issues", "changelog_uri" => "https://github.com/cucumber/cucumber-rails/blob/v3.0.0/CHANGELOG.md", "documentation_uri" => "https://cucumber.io/docs", "mailing_list_uri" => "https://groups.google.com/forum/#!forum/cukes", "source_code_uri" => "https://github.com/cucumber/cucumber-rails/tree/v3.0.0" } if s.respond_to? :metadata=
  ...
  s.summary = "cucumber-rails-3.0.0".freeze
  ...
  s.add_runtime_dependency(%q<railties>.freeze, [">= 5.2".freeze, "< 8".freeze])
  ...
  s.add_development_dependency(%q<database_cleaner>.freeze, [">= 1.8".freeze, "< 3.0".freeze])
